    ...
    <aside className="fixed left-0 top-0 h-screen w-[144px] bg-primary text-primary-foreground flex flex-col border-r border-white/10">
        ...
        {navItems.map((item) => {
          ...
          return (
            <button
              ...
              className={cn(
                "w-full px-2 py-2.5 flex flex-col items-center gap-1 text-white/70 hover:text-white hover:bg-white/10 transition-colors relative",
            ...
            >
              ...
              {item.items && (
                <ChevronRight className={cn(
                  "w-3 h-3 absolute right-1.5 top-1/2 -translate-y-1/2 transition-transform",
                  isActive && "rotate-90"
                )} />
              )}
            </button>
      ...
      <div className="border-t border-white/10">
        <button
          ...
          className="w-full px-2 py-2.5 flex flex-col items-center gap-1 text-white/70 hover:text-white hover:bg-white/10 transition-colors"
        >
          <Search className="w-5 h-5" />
          <span className="text-[11px] font-medium">Search</span>
        </button>

        <button className="w-full px-2 py-2.5 flex flex-col items-center gap-1 text-white/70 hover:text-white hover:bg-white/10 transition-colors">
        ...
        <div className="p-2 border-t border-white/10">
          <div className="w-8 h-8 mx-auto rounded-full bg-accent flex items-center justify-center">
            <User className="w-4 h-4 text-white" />
          </div>
          <p className="text-[10px] text-white/60 text-center mt-1 truncate">Admin</p>
        </div>
      </div>
    </aside>
  );
